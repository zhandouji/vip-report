(function(root, factory) {
    ...
    var defaults = {
        ...
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" id="{id}" {action}>{value}</li>',
    ...
    Date.prototype.isSpecial = function(y, m, d) {
    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
           ...
           /* if (dt.isSpecial(y, m, d)) {
                data['class'] += ' ' + SPECIAL_DAY_CLASS;
            }*/
