...
function companyDetail(id) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      $("#companyName").html(data.obj.name
          + "<dd class=\"attestation-title\"><img class=\"attestation-img\" src=\"/theme/dmapp/img/daming/attestation.png\"/> \u5DF2\u8BA4\u8BC1</dd>");
      ...
      $("#companyTel").html("<a class=\"color-gray-999\" >"
          ...
          + "\"  onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a></a>");
      $("#companyChargeDesc").html("" + (data.obj.chargeDesc == '' ? '暂无'
          : data.obj.chargeDesc));
      layer.closeAll();
    }
  });
      ...
      if (data.list !== null && data.list.length > 0 && unlockerPageAppend) {
        $.each(data.list, function (index, value) {
          var html = "\n<li class=\"clear\" onclick=\"window.location.href='"
              + BASESERVLET + "/api/app/unlock/unlocker/toDetail/" + value.id
              + "/" + value.companyId
              + "'\">\n                            <a href=\"javascript:void(0);\" >\n                                <img class=\"person-img\" src=\""
              + (value.headImg === null ? "/theme/dmapp/img/daming/yonghu.png"
                  : BASESERVLET + "/web/file/" + value.headImg)
              ...
              + "\u6B21</span></p>\n                                </div>\n                            </a>\n                        </li>\n                    ";
          $("#list1").append(html);
          grade_star($("#star_" + value.companyId + "_" + value.id),
              value.score);
        });
        /*
         * 判断是否还有更多数据
...
function unlockerDetail(id) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      var html = "\n                <img class=\"person-img\" src=\""
          + (data.obj.headImg === null ? "/theme/dmapp/img/daming/yonghu.png"
              : BASESERVLET + "/web/file/" + data.obj.headImg)
          + "\" />\n                <div class=\"person-message\">\n                    <p >\u9501\u5320\u540D\u79F0\uFF1A"
          + data.obj.name
          + "</p>\n                    <p>\u8054\u7CFB\u7535\u8BDD\uFF1A\n                        <a>"
          + data.obj.tel + "<a href=\"tel:" + data.obj.tel
          + "\" onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a></a>\n                    </p>\n                    <p>\u670D\u52A1\u6B21\u6570\uFF1A"
          + (data.obj.serviceNum == null ? 0 : data.obj.serviceNum)
          + "\u6B21</p>\n                    <div class=\"datail-star-box\">\n                        <span class=\"vertical-align-middle\">\u8BC4\u4EF7\u661F\u7EA7\uFF1A</span>\n                        <ul class=\"grade-star vertical-align-middle\" id=\"star_"
          + data.obj.id
          + "\">\n                            <li>\n                                <span class=\"star-bg\"></span>\n                                <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                            </li>\n                            <li>\n                                <span class=\"star-bg\"></span>\n                                <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                            </li>\n                            <li>\n                                <span class=\"star-bg\"></span>\n                                <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                            </li>\n                            <li>\n                                <span class=\"star-bg\"></span>\n                                <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                            </li>\n                            <li>\n                                <span class=\"star-bg\"></span>\n                                <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                            </li>\n                        </ul>\n                        <span class=\"color-white-orange vertical-align-middle\">"
          + data.obj.score
          + "</span>\n                    </div>\n                </div>\n            ";
...
function commentList(type, unlockerId) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.list !== null && data.list.length > 0 && commentPageAppend) {
        $.each(data.list, function (index, value) {
          ...
          var html = "\n                        <li>\n                            <div class=\"comments-user-box clear\">\n                                <div class=\"user-img\"></div>\n                                <div class=\"user-name\">\n                                    <p><span>"
              + value.userName
              + "</span><span class=\"color-gray-999 float-right\"> " + dateStr
              + "</span></p>\n                                    <p><span class=\"color-gray-999 font-size-028rem\">"
              + value.userTel
      ...
      loadrefresh();
      $("#commentTotal").html("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\u5171\u6709"
          + data.obj.totalRow + "\u6761\u7528\u6237\u8BC4\u4EF7");
      layer.closeAll();
    }
  });
}
