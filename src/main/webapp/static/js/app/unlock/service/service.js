...
function serviceList(type, status, userIdentity) {
    ...
    var param = { pageStart: servicePageStart, status: status, userIdentity: userIdentity };
        ...
        success: function success(data) {
            ...
            if (data.list !== null && data.list.length > 0 && servicePageAppend) {
                $.each(data.list, function (index, value) {
                    var createTimeStr = new Date(value.createTime).format("yyyy-MM-dd hh:mm:ss");
                    var statusStr = "";
                    if (value.status === 1) {
                        statusStr = "待服务";
                    ...
                    if (userIdentity === '1') {
                        ...
                        if (value.status === 1) {
                            operate += "\n                                <button class=\"color-gray-999 border-gray-e0\" onclick=\"toCancel('" + value.id + "')\">\u53D6\u6D88\u8BA2\u5355</button>\n                                <button class=\"color-gray-999 border-gray-e0\" onclick=\"toUnlockerEdit('" + value.id + "')\">\u4FEE\u6539\u4FE1\u606F</button>\n                                <button class=\"color-blue border-blue\" onclick=\"toUnlock('" + value.id + "', '" + value.userId + "')\">\u76F4\u64AD\u5F00\u9501</button>\n                            ";
                        }
                        if (value.status === 2 || value.status === 3 || value.status === 4) {
                            operate += "\n                                <button class=\"color-gray-999 border-gray-e0\" onclick=\"del('" + value.id + "', 1)\">\u5220\u9664\u8BA2\u5355</button>\n                            ";
                            if (isEmpty(value.repairPics) && value.status !== 4) {
                                operate += "\n                                    <button class=\"color-gray-999 border-gray-e0\" onclick=\"toRepair('" + value.id + "', '" + value.userId + "')\">\u8865\u5F55\u7167\u7247</button>\n                                ";
                            }
                        }
                        operate += "</div>";
                        ...
                        if (value.status === 2 || value.status === 3 || value.status === 4) {
                            operate += "\n                                <button class=\"color-gray-999 border-gray-e0\" onclick=\"del('" + value.id + "', 2)\">\u5220\u9664\u8BA2\u5355</button>\n                            ";
                        }
                        if (value.status === 2) {
                            operate += "\n                                <button class=\"color-blue border-blue\" onclick=\"toComment('" + value.id + "')\">\u53BB\u8BC4\u4EF7</button>\n                            ";
                        }
                        operate += "</div>";
                    } else if (userIdentity === '3') {
                        operate += "\n                            <p>\n                                <a>\n                                    <img class=\"icon-person\" src=\"/theme/dmapp/img/daming/icon-person.png\" />\n                                    <span class=\"color-gray-666 vertical-align-middle\">\n                                        <a>" + value.userTel + "\n                                            <a href=\"tel:" + value.userTel + "\"  onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a>\n                                        </a>\n                                    </span>\n                                </a>\n                            </p>\n                        ";
                    }

                    var html = "\n                        <li>\n                            <a href=\"javascript:void(0)\" onclick=\"window.location.href = '" + BASESERVLET + "/api/app/unlock/service/toDetail/" + value.id + "/" + userIdentity + "';\">\n                                <div class=\"service-cell-title clear\">\n                                    <span class=\"cell-title\">" + value.typeName + "</span>\n                                    <span class=\"cell-type\">" + statusStr + "</span>\n                                </div>\n                                <p><img class=\"icon-time\" src=\"/theme/dmapp/img/daming/time.png\" /><span class=\"color-gray-666 vertical-align-middle\">" + createTimeStr + "</span></p>\n                                <p><img class=\"icon-location\" src=\"/theme/dmapp/img/daming/list_icon_location.png\" /><span class=\"location-text vertical-align-middle\">" + value.addressFull + "</span></p>\n                            </a>\n                            " + operate + "\n                        </li>\n                    ";
                    $("#list").append(html);
                });
                /*
                 * 判断是否还有更多数据
...
function unlockerSave() {
    ...
    var param = { userId: userId, type: unlockType, addressMain: addressMain, createRemark: createRemark, userPics: userPics,
        userName: userName, userCardNo: userCardNo };
    layer.open({ type: 2, shade: 'background-color: rgba(0,0,0,.1)' });
    $.ajax({
        type: "post",
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            if (data.obj.isVerify === 0) {
                html = "\n                    <img class=\"person-img\" src=\"" + (data.obj.icon === null ? "/theme/dmapp/img/daming/yonghu.png" : "" + data.obj.facePhoto) + "\" />\n                    <div class=\"person-message\">\n                        <input type=\"hidden\" id=\"userId\" value=\"" + id + "\"/>\n                        <input type=\"hidden\" id=\"isVerify\" value=\"" + data.obj.isVerify + "\"/>\n                        <p>\u5BA2\u6237\u59D3\u540D\uFF1A<input class=\"input-name\" type=\"text\" id=\"userName\" value=\"\" placeholder=\"\u8BF7\u8F93\u5165\" /></p>\n                        <p>\u8EAB\u4EFD\u8BC1\u53F7\uFF1A<input class=\"input-name\" type=\"text\" id=\"userCardNo\" value=\"\" placeholder=\"\u8BF7\u8F93\u5165\" /></p>\n                        <p>\u6027\u3000\u3000\u522B\uFF1A" + (data.obj.gender === 1 ? "\u7537" : "\u5973") + "</p>\n                        <p>\u8054\u7CFB\u7535\u8BDD\uFF1A" + data.obj.phone + "</p>\n                    </div>\n                ";
            } else {
                html = "\n                    <img class=\"person-img\" src=\"" + (data.obj.icon === null ? "/theme/dmapp/img/daming/yonghu.png" : BASESERVLET + "/web/file/" + data.obj.icon) + "\" />\n                    <div class=\"person-message\">\n                        <input type=\"hidden\" id=\"userId\" value=\"" + id + "\"/>\n                        <input type=\"hidden\" id=\"isVerify\" value=\"" + data.obj.isVerify + "\"/>\n                        <p>\u5BA2\u6237\u540D\u79F0\uFF1A" + data.obj.name + "</p>\n                        <p>\u8EAB\u4EFD\u8BC1\u53F7\uFF1A" + (data.obj.id.substring(0, 10) + "****" + data.obj.id.substring(14, 18)) + "</p>\n                        <p>\u6027\u3000\u3000\u522B\uFF1A" + (data.obj.gender === 1 ? "\u7537" : "\u5973") + "</p>\n                        <p>\u8054\u7CFB\u7535\u8BDD\uFF1A" + data.obj.phone + "</p>\n                    </div>\n                ";
            }
...
function findUserDetailFromService(id) {
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            var html = "\n                <img class=\"person-img\" src=\"" + (data.obj.userHeadImg === null ? "/theme/dmapp/img/daming/yonghu.png" : BASESERVLET + "/web/file/" + data.obj.userHeadImg) + "\" />\n                <div class=\"person-message\">\n                    <input type=\"hidden\" id=\"userId\" value=\"" + id + "\"/>\n                    <p>\u5BA2\u6237\u540D\u79F0\uFF1A" + data.obj.userName + "</p>\n                    <p>\u8EAB\u4EFD\u8BC1\u53F7\uFF1A" + (data.obj.userCardNo.substring(0, 10) + "****" + data.obj.userCardNo.substring(14, 18)) + "</p>\n                    <p>\u6027\u3000\u3000\u522B\uFF1A" + (data.obj.userSex === '1' ? "\u7537" : "\u5973") + "</p>\n                    <p>\u8054\u7CFB\u7535\u8BDD\uFF1A" + data.obj.userTel + "</p>\n                </div>\n            ";
            $("#personMessage").html(html);
            layer.closeAll();
        }
    });
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            if (userIdentity === '1' || userIdentity === '3') {
                personMessage = "\n                    <img class=\"person-img\" src=\"" + (data.obj.userHeadImg === null ? "/theme/dmapp/img/daming/yonghu.png" : BASESERVLET + "/web/file/" + data.obj.userHeadImg) + "\" />\n                    <div class=\"person-message\">\n                        <p>\u5BA2\u6237\u540D\u79F0\uFF1A" + data.obj.userName + "</p>\n                        <p>\u8EAB\u4EFD\u8BC1\u53F7\uFF1A" + (data.obj.userCardNo.substring(0, 10) + "****" + data.obj.userCardNo.substring(14, 18)) + "</p>\n                        <p>\u6027\u3000\u3000\u522B\uFF1A" + (data.obj.userSex === '1' ? "\u7537" : "\u5973") + "</p>\n                        <p>\u8054\u7CFB\u7535\u8BDD\uFF1A\n                            " + data.obj.userTel + "<a href=\"tel:" + data.obj.userTel + "\" onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a>\n                        </p>\n                    </div>\n                ";
            } else if (userIdentity === '2') {
                personMessage = "\n                    <img class=\"person-img\" src=\"" + (data.obj.unlockerHeadImg === null ? "/theme/dmapp/img/daming/yonghu.png" : BASESERVLET + "/web/file/" + data.obj.unlockerHeadImg) + "\" />\n                    <div class=\"person-message\">\n                        <p>\u9501\u5320\u540D\u79F0\uFF1A" + data.obj.unlockerName + "\n                            <a class=\"float-right color-blue\" href=\"javascript:void(0);\" onclick=\"window.location.href='" + BASESERVLET + "/api/app/unlock/unlocker/toDetail/" + data.obj.unlockerId + "/" + data.obj.companyId + "'\">\u8BE6\u60C5></a>\n                        </p>\n                        <p>\u8EAB\u4EFD\u8BC1\u53F7\uFF1A" + (data.obj.unlockerCardNo.substring(0, 10) + "****" + data.obj.unlockerCardNo.substring(14, 18)) + "</p>\n                        <p>\u6027\u3000\u3000\u522B\uFF1A" + (data.obj.unlockerSex === '1' ? "\u7537" : "\u5973") + "</p>\n                        <p>\u8054\u7CFB\u7535\u8BDD\uFF1A\n                            " + data.obj.unlockerTel + "<a href=\"tel:" + data.obj.unlockerTel + "\" onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a>\n                        </p>\n                    </div>\n                ";
            }

            //订单信息
            var orderInfo = "\n                <p class=\"part-title\">\u2014\u2014&nbsp;\u8BA2\u5355\u4FE1\u606F&nbsp;\u2014\u2014</p>\n                <ul>\n                    <li>\n                        <span>\u8BA2\u5355\u72B6\u6001</span>\n                        <span class=\"color-blue\">\n                        " + (data.obj.status === 1 ? "\u5F85\u670D\u52A1" : "") + "\n                        " + (data.obj.status === 2 ? "\u5DF2\u5B8C\u6210" : "") + "\n                        " + (data.obj.status === 3 ? "\u5DF2\u8BC4\u4EF7" : "") + "\n                        " + (data.obj.status === 4 ? "\u5DF2\u53D6\u6D88" : "") + "\n                        </span>\n                    </li>\n                    <li>\n                        <span>\u5F00\u9501\u7C7B\u578B</span>\n                        <span>" + data.obj.typeName + "</span>\n                    </li>\n                    <li>\n                        <span>\u8BE6\u7EC6\u5730\u5740</span>\n                        <span>" + data.obj.addressFull + "</span>\n                    </li>\n                    <li>\n                        <span>\u5907\u6CE8\u5185\u5BB9</span>\n                        <span>" + data.obj.createRemark + "</span>\n                    </li>\n                </ul>\n            ";
            //获取住户身份照片
            var userPicHtml = "";
            if (data.obj.userPics !== null && data.obj.userPics !== '') {
                ...
                if (userPic.length > 0) {
                    ...
                    $.each(userPic, function (index, value) {
                        userPicImg += "<img src=\"" + BASESERVLET + "/api/fileWithCompress/" + value + "\" onclick=\"enlargeImageAndroid('" + value + "')\"/>";
                    });
            ...
            if (data.obj.repairPics !== null && data.obj.repairPics !== '') {
                ...
                if (repairPic.length > 0) {
                    ...
                    $.each(repairPic, function (index, value) {
                        repairPicImg += "<img src=\"" + BASESERVLET + "/api/fileWithCompress/" + value + "\" onclick=\"enlargeImageAndroid('" + value + "')\"/>";
                    });
                    repairPicHtml = "\n                        <li>\n                            <p>\u8865\u5F55\u4F4F\u6237\u8EAB\u4EFD\u7167\u7247</p>\n                            <div class=\"id-card-group\">\n                                <div>" + repairPicImg + "</div>\n                            </div>\n                        </li>\n                    ";
                }
            }
            //照片&视频信息
            ...
            //评价信息
            var unlocker = "\n                <div class=\"more-message-cell\">\n\t\t\t\t\t<p class=\"part-title\">\u2014\u2014&nbsp;\u670D\u52A1\u4EBA\u5458&nbsp;\u2014\u2014</p>\n\t\t\t\t\t<ul>\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t<span>\u9501\u5320\u59D3\u540D</span>\n\t\t\t\t\t\t\t<span>" + data.obj.unlockerName + "</span>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t<span>\u9501\u5320\u7535\u8BDD</span>\n\t\t\t\t\t\t\t<span>" + data.obj.unlockerTel + "<a href=\"tel:" + data.obj.unlockerTel + "\"  onclick=\"event.stopPropagation()\"><img class=\"dial-phone\" src=\"/theme/dmapp/img/daming/dial-phone.png\" /></a></span>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n            ";

            //评价信息
            var comment = "\n                <div class=\"more-message-cell\">\n                    <p class=\"part-title\">\u2014\u2014&nbsp;\u8BC4\u4EF7\u4FE1\u606F&nbsp;\u2014\u2014</p>\n                    <ul>\n                        <li>\n                            <span class=\"vertical-align-middle\">\u8BC4\u4EF7\u661F\u7EA7</span>\n                            <ul class=\"grade-star vertical-align-middle margin-left-0\">\n                                <li>\n                                    <span class=\"star-bg\"></span>\n                                    <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                                </li>\n                                <li>\n                                    <span class=\"star-bg\"></span>\n                                    <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                                </li>\n                                <li>\n                                    <span class=\"star-bg\"></span>\n                                    <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                                </li>\n                                <li>\n                                    <span class=\"star-bg\"></span>\n                                    <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                                </li>\n                                <li>\n                                    <span class=\"star-bg\"></span>\n                                    <img class=\"icon-star\" src=\"/theme/dmapp/img/daming/icon_star.png\" />\n                                </li>\n                            </ul>\n                        </li>\n                        <li>\n                            <span>\u8BC4\u4EF7\u5185\u5BB9</span>\n                            <span>" + data.obj.comment + "</span>\n                        </li>\n                    </ul>\n                </div>\n            ";

            //时间信息
            var createTimeStr = new Date(data.obj.createTime).format("yyyy-MM-dd hh:mm:ss");
            var completeTimeStr = new Date(data.obj.completeTime).format("yyyy-MM-dd hh:mm:ss");
            var createTimeHtml = "\n                <span>\u521B\u5EFA\u65F6\u95F4</span>\n                <span>" + createTimeStr + "</span>\n            ";
            var completeTimeHtml = "\n                <span>\u5B8C\u6210\u65F6\u95F4</span>\n                <span>" + completeTimeStr + "</span>\n            ";
            ...
            if (userIdentity === '1') {
                if (status === 1) {
                  bottomButton = "\n                        <div class=\"bottom-button-box button-center-box\" >\n                            <button class=\"cancel-little-button margin-right-025rem\" onclick=\"toCancel('"
                      + data.obj.id
                      + "')\">\u53D6\u6D88\u670D\u52A1</button>\n                            <button class=\"inquire-little-button  bg-bluish-violet\" onclick=\"toUnlock('"
                      + data.obj.id + "','" + data.obj.userId
                      + "')\">\u76F4\u64AD\u5F00\u9501</button>\n                        </div>\n                    ";
                }
            } else if (userIdentity === '2') {
                if (status === 1) {
                    bottomButton = "\n                        <div class=\"button-center-box\">\n                            <button class=\"cancel-button\" onclick=\"toCancel('" + data.obj.id + "')\">\u53D6\u6D88\u670D\u52A1</button>\n                        </div>\n                    ";
                }
                if (status === 2) {
                  bottomButton = "\n                        <div class=\"button-center-box\">\n                            <button class='inquire-button  bg-bluish-violet' onclick=\"toComment('"
                      + data.obj.id
                      + "')\">\u53BB\u8BC4\u4EF7</button>\n                        </div>\n                    ";
                }
            }
...
function toUnlockerEdit(id) {
    window.location.href = BASESERVLET + '/api/app/unlock/service/toUnlockerEdit/' + id;
}
...
function editDetail(id) {
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            if (data.obj.isVerify === 0) {
                userNameP = '客户姓名：<input class="input-name" type="text" id="userName" ' + 'value="' + data.obj.userName + '" placeholder="请输入" />';
                userCardNoP = '身份证号：<input class="input-name" type="text" id="userCardNo" ' + 'value="' + data.obj.userCardNo + '" placeholder="请输入" />';
            } else {
                userNameP = '客户名称：' + data.obj.userName;
                userCardNoP = '身份证号：' + data.obj.userCardNo.substring(0, 10) + '****' + data.obj.userCardNo.substring(14, 18);
            }

            $('#isVerify').val(data.obj.isVerify);
            $('#userHeadImg').attr('src', data.obj.userHeadImg === null ? '/theme/dmapp/img/daming/yonghu.png' : '${BASESERVLET}/web/file/${data.obj.userHeadImg}');
...
function unlockerEdit(id) {
    ...
    var param = { id: id, type: unlockType, addressMain: addressMain,
        createRemark: createRemark, userPics: userPics, userName: userName, userCardNo: userCardNo };
    layer.open({ type: 2, shade: 'background-color: rgba(0,0,0,.1)' });
    $.ajax({
        type: "post",
...
function toUnlock(id, userId) {
    window.location.href = BASESERVLET + '/api/app/unlock/service/toUnlock/' + id + '/' + userId;
}
...
function toRepair(id, userId) {
    window.location.href = BASESERVLET + '/api/app/unlock/service/toRepair/' + id + '/' + userId;
}
...
function toComment(id) {
    window.location.href = BASESERVLET + '/api/app/unlock/service/toComment/' + id;
}
...
function commentServiceDetail(id) {
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            var completeTimeStr = new Date(data.obj.completeTime).format("yyyy-MM-dd hh:mm:ss");
            var info = "\n                <p><span>" + data.obj.unlockerName + "-" + data.obj.typeName + "</span></p>\n                <p><span class=\"color-gray-999 font-size-028rem\" >\u5B8C\u6210\u65F6\u95F4&nbsp;&nbsp;" + completeTimeStr + "</span></p>\n            ";
            $("#info").html(info);
            layer.closeAll();
        }
    });
