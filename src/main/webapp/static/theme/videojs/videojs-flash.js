...
(function (global, factory) {
  ...
  videojs = videojs && videojs.hasOwnProperty('default') ? videojs['default']
      : videojs;
  ...
  var Flash = function (_Tech) {
    ...
    Flash.prototype.setCurrentTime = function setCurrentTime(time) {
      ...
      if (seekable.length) {
        ...
        time = time < seekable.end(seekable.length - 1) ? time : seekable.end(
                seekable.length - 1);
    ...
    Flash.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
      ...
      if (window_1.performance && typeof window_1.performance.now
          === 'function') {
        videoPlaybackQuality.creationTime = window_1.performance.now();
      } else if (window_1.performance && window_1.performance.timing
          && typeof window_1.performance.timing.navigationStart === 'number') {
        videoPlaybackQuality.creationTime = window_1.Date.now()
            - window_1.performance.timing.navigationStart;
      }
...
// Create setters and getters for attributes
  ...
  var _readWrite = ['rtmpConnection', 'rtmpStream', 'preload',
    'defaultPlaybackRate', 'playbackRate', 'autoplay', 'loop', 'controls',
    'volume', 'muted', 'defaultMuted'];
  var _readOnly = ['networkState', 'readyState', 'initialTime',
    'startOffsetTime', 'paused', 'ended', 'videoWidth', 'videoHeight'];
...
// Register the native source handler
  ...
  Flash.version = function () {
    ...
    // IE
    try {
      version$$1 = new window_1.ActiveXObject('ShockwaveFlash.ShockwaveFlash').GetVariable(
      ...
      try {
        if (navigator.mimeTypes['application/x-shockwave-flash'].enabledPlugin) {
          version$$1 = (navigator.plugins['Shockwave Flash 2.0']
