		...
		<div class="main-content-box">
			...
			<div class="map-nav clear">
				<div class="left-map-title">
					<span id="firstli">接警中心</span><span>&nbsp;/&nbsp;</span><span id="secondli">接警中心管理</span>
				</div>
...
<%--高德地图--%>
<script type="text/javascript" src="https://webapi.amap.com/maps?v=1.4.2&key=9cef69900a5e27dcebd883de1cf0b776&plugin=AMap.Geocoder,AMap.CitySearch"></script>
...
<script type="text/javascript" src="/js/common/pubsub.js"></script>
<script type="text/javascript" src="/js/socket.js"></script>
<script type="text/javascript" src="/js/commonMessage.js?time=20180612"></script>
<%--高德地图UI库--%>
